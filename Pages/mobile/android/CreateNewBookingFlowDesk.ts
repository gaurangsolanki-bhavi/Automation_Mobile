...
class CreateNewBookingFlowDesk {
    actionClass: Actions;
    ...
    async verifyCreateNewBookingDeskAllDay(zone: string) {
        console.log("\n");
        console.log("--------------------------------------------------------------------");
        console.log("Verifying Create New Desk Booking Page Elements...");
        console.log("--------------------------------------------------------------------");
        await this.actionClass.isElementDisplayed(await Locatore.iconSteps, MobileData.Create_New_Booking.Progress_Bar);
        await this.actionClass.waitForElementAndClick(await Locatore.btnDesk);
        const titleTextDeskButton = await (await Locatore.btnDesk).getAttribute('text');
        await this.actionClass.assertElementTextEquals(titleTextDeskButton, MobileData.Create_New_Booking.Title_Text_Desk_Button);
        const enabledDeskButton = await (await Locatore.btnDesk).getAttribute('enabled');
        if (enabledDeskButton === 'true') {
            console.log("Desk Button is Enabled");
            ...
            console.log("🚫 Desk Button is Disabled ❌ | Desk Zone is not available");
        }
    }
    ...
    async verifyCreateNewBookingSecondPage() {
        ...
        if (await popupNoSpaceAvailable.isDisplayed()) {
            ...
            if (popupMessage) {
                throw new Error("🚫 No Space Available Popup displayed");
            }
            return;
        }
        ...
        if (!dropdownNoSpaceAvailable) {
            ...
            console.log("----------------------------------------------------");
            console.log("Spaces are available in the selected zone.");
            console.log("----------------------------------------------------");
            await this.reusableMobilePage.waitForLoaderToDisappear(await Locatore.loader);
    ...
    async verifyCreateNewBookingDeskHourly(zone: string) {
        console.log("\n");
        console.log("--------------------------------------------------------------------");
        console.log("Verifying Create New Booking Page Elements for Hourly Desk...");
        console.log("--------------------------------------------------------------------");
        const enabledDeskButton = await (await Locatore.btnDesk).getAttribute('enabled');
        if (enabledDeskButton === 'true') {
            console.log("Desk Button is Enabled");
    ...
    async verifyCreateNewBookingDeskHourly2(zone: string) {
        console.log("\n");
        console.log("--------------------------------------------------------------------");
    ...
    async verifyCreateNewBookingDeskHourlyMixZone(zone: string) {
        console.log("\n");
        console.log("--------------------------------------------------------------------");
...
export default CreateNewBookingFlowDesk;